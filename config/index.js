export const config = {
    ...
    // }]
    USERS: [
      {name: '养念念和喵', id: "BRhTZ6Svh93xtB5Wvmyu_Ppi3YBb2eIMc57jquE8abg"}, 
      {name:'清如笺素',id:"BRhTZ6Svh93xtB5Wvmyu_Ppi3YBb2eIMc57jquE8abgc"}
      //可以填多个
    ],
    // 接收成功回调消息的微信号，（一般来说只填自己的微信号, name填不填无所谓）
    CALLBACK_USERS: [
      {name: '自己',id: "o9hvX5mfJCjGzyl2iBbB84XpYhic"}, 
    ],
